#!/bin/bash
#SBATCH -A nstaff
#SBATCH -x cgpu08,cgpu11,cgpu12,cgpu14,cgpu06
#SBATCH	--nodes=8
...
data_dir_prefix="/global/homes/m/mrowan/scratch/ml-performance-benchmark/deepcam/cori/data/cam5_data/All-Hist_small_split_4"
